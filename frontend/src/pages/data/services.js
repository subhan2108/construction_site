...
const services = [
  {
    ...
    description: "Comprehensive solutions for commercial, residential, and industrial projects.",
    detail:
      "Al Tawafuq Advance Contracting Company, we deliver a full spectrum of contracting and construction services designed to meet the evolving needs of our clients. From civil and structural works to mechanical, electrical, and plumbing (MEP) services, our expertise ensures that every project is executed with precision and professionalism. We specialize in residential, commercial, and industrial developments, offering tailored solutions that align with international standards of quality and safety. At Certification & Compliance Est, we pride ourselves on being a reliable partner, delivering cutting-edge solutions, expert teamwork, and on-time project delivery that contribute to the growth and success of our clients and communities.",
    image: sr7,
  },
  {
    id: 2,
    title: "Civil Works",
    description: "Roads, foundations, concrete structures, and infrastructure development.",
    detail:
  ...
  },
  {
    ...
    description: "Steel fabrication, building frameworks, and structural reinforcement.",
    detail:
  ...
  },
  {
    id: 4,
    title: "MEP Services",
    description: "Mechanical, electrical, and plumbing works with full compliance.",
    detail:
  ...
  },
{
    ...
    description: "Preventive and corrective maintenance for long-term durability.",
    detail:
